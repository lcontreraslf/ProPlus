...
import { Building, Home, Search, Phone, Menu, X, User, LogIn, LogOut, PlusCircle, LayoutDashboard, Contact } from 'lucide-react';
...
const Navbar = () => {
  ...
  const navItems = [
    { path: '/propiedades?operation=venta', label: 'Propiedades en Venta', icon: Building },
    { path: '/propiedades?operation=arriendo', label: 'Propiedades en Arriendo', icon: Building },
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-4 lg:space-x-6">
              {navItems.map((item) => {
                ...
                const isActive = location.pathname + location.search === item.path || (location.pathname === "/propiedades" && item.path.startsWith("/propiedades") && !location.search && (item.path.includes("venta") || item.path.includes("arriendo")));
